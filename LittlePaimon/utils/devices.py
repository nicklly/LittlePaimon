...
DEVICE_VARIANTS = [
    # 原始设备（按 record 参数顺序重排）
    DeviceVariant(
        DeviceModel='24031PN0DC', ProductName='aurora', Brand='Xiaomi',
        Board='24031PN0DC', Hardware='Xiaomi', DeviceType='aurora',
        Manufacturer='Xiaomi',
    ...
    DeviceVariant(
        DeviceModel='2211133C', ProductName='fuxi', Brand='Xiaomi',
        Board='2211133C', Hardware='qcom', DeviceType='fuxi',
        Manufacturer='Xiaomi',
    ...
    DeviceVariant(
        DeviceModel='23127PN0CC', ProductName='shennong', Brand='Xiaomi',
        Board='23127PN0CC', Hardware='qcom', DeviceType='shennong',
        Manufacturer='Xiaomi',
    ...
    DeviceVariant(
        DeviceModel='V2366GA', ProductName='PD2366', Brand='vivo',
        Board='V2366GA', Hardware='vivo', DeviceType='PD2366',
        Manufacturer='vivo',
    ...
    DeviceVariant(
        DeviceModel='ALN-AL80', ProductName='alps', Brand='Huawei',
        Board='ALN-AL80', Hardware='kirin9000s', DeviceType='HWALN',
        Manufacturer='Huawei',
    ...
    DeviceVariant(
        DeviceModel='PGT-AN10', ProductName='pegasus', Brand='Honor',
        Board='PGT-AN10', Hardware='sm8550', DeviceType='HNPEGASUS',
        Manufacturer='Honor',
    ...
    DeviceVariant(
        DeviceModel='PGEM10', ProductName='pearl', Brand='OPPO',
        Board='PGEM10', Hardware='sm8550', DeviceType='OP5949L1',
        Manufacturer='OPPO',
    ...
    DeviceVariant(
        DeviceModel='PHB110', ProductName='salami', Brand='OnePlus',
        Board='PHB110', Hardware='sm8550', DeviceType='OnePlusPHB110',
    ...
    DeviceVariant(
        DeviceModel='RMX3888', ProductName='titan', Brand='realme',
        Board='RMX3888', Hardware='sm8550', DeviceType='RE58BAL1',
        Manufacturer='realme',
    ...
    DeviceVariant(
        DeviceModel='M391Q', ProductName='meizu20pro', Brand='Meizu',
        Board='M391Q', Hardware='sm8550', DeviceType='meizu_M391Q',
        Manufacturer='Meizu',
    ...
    DeviceVariant(
        DeviceModel='MNA-AL00', ProductName='mona', Brand='Huawei',
        Board='MNA-AL00', Hardware='sm8475', DeviceType='HWMNA',
        Manufacturer='Huawei',
    ...
    DeviceVariant(
        DeviceModel='REA-AN00', ProductName='rea', Brand='Honor',
        Board='REA-AN00', Hardware='sm7450', DeviceType='HNREA',
        Manufacturer='Honor',
    ...
    DeviceVariant(
        DeviceModel='V2309A', ProductName='vivoX100Pro', Brand='vivo',
        Board='V2309A', Hardware='mt6989', DeviceType='PD2309',
        Manufacturer='vivo',
    ...
    DeviceVariant(
        DeviceModel='CPH2521', ProductName='douglas', Brand='OPPO',
        Board='CPH2521', Hardware='sm7450', DeviceType='OP594DL1',
        Manufacturer='OPPO',
    ...
    DeviceVariant(
        DeviceModel='2304FPN6DC', ProductName='ishtar', Brand='Xiaomi',
        Board='2304FPN6DC', Hardware='qcom', DeviceType='ishtar',
        Manufacturer='Xiaomi',
    ...
    DeviceVariant(
        DeviceModel='22127RK46C', ProductName='mondrian', Brand='Redmi',
        Board='22127RK46C', Hardware='qcom', DeviceType='mondrian',
        Manufacturer='Xiaomi',
